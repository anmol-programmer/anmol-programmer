...
## 🎯 About Me
🎓 **Computer Science Student** | 🐍 **Aspiring Python Master** | 🌐 **Networking & Cybersecurity Enthusiast**  

🚀 Passionate about mastering **Advanced Python**, improving **coding skills**, and learning **new tech every day**  
💡 Continuously exploring Python, DSA, C++, Networking, Kali Linux, SQL, Git/GitHub, and productivity tools  
🎯 Goal: Become a Skilled **Software & Network Engineer**, and a lifelong learner in tech  

## 🛠 Skills
- **Programming & Scripting:** Python (Advanced), C++, C, Java, SQL  
- **Networking & Cybersecurity:** CCNA Basics, TCP/IP, OSI Model, Kali Linux, Ethical Hacking  
- **Version Control & Collaboration:** Git, GitHub  
- **Design & Productivity Tools:** Canva, MS Office, VS Code  

## 📌 Current Focus
- Mastering **Advanced Python Projects, Automation Scripts & Automation Projects**  
- Building **Networking & Cybersecurity Labs**  
...
## 🔥 Let's Connect & Build Advanced Python & Networking Projects!
